    ...
    function renderSubtaskTable(parentTask) {
        ...
        $.each(allRows, function (idx, row) {
            ...
            for (var ci = 0; ci < connList.length; ci++) {
                ...
                if (ctype === 'branch') {
                    $treeCell.append($('<span class="tree-connector has-more">'));
                } else if (ctype === 'last') {
                    $treeCell.append($('<span class="tree-connector">'));
                } else if (ctype === 'vline') {
                    $treeCell.append($('<span class="tree-vline">'));
                } else {
                    $treeCell.append($('<span class="tree-spacer">'));
                }
            }
